...
def main() -> None:
    ...
    summary = {
        "status": "placeholder",
        "message": (
            "Ce script servira à entraîner le modèle BUT à partir de "
        ...
        "expected_outputs": [
            ...
            "outputs/metrics_modele_but_enrichi_v1.csv",
            "outputs/predictions_validation_but_v2.csv",
            "outputs/predictions_test_but_v2.csv",
            "outputs/predictions_validation_but_enrichi_v1.csv",
            "outputs/predictions_test_but_enrichi_v1.csv",
        ],
        "next_step": (
            "Copier depuis le notebook Colab les blocs d'entraînement du modèle "
            "BUT baseline et enrichi."
        ),
    }

    OUTPUTS_DIR.mkdir(parents=True, exist_ok=True)
    summary_path = OUTPUTS_DIR / "04_train_goal_model_summary.json"
